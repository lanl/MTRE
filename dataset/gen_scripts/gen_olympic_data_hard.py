...
def ensure_dir(path="./data/OlympicLikeLogo"):
...
def draw_circles(dpi, size, radius, centers, colors, thickness):
    ...
    path = f"{ensure_dir('./data/OlympicLikeLogo')}/{image_id}.png"
...
def main():
                        ...
                        for num in num_circles_list:
                            ...
                            for colors in color_modes:
                                for centers in randomized_batches:
                                    ...
                                    # If you want to also generate triangles, uncomment:
    ...
    print(len(metadata))
    save_dir = ensure_dir("./data/OlympicLikeLogo")
