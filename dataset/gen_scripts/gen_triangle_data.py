#!/usr/bin/env python3
"""
Triangle Counting Dataset Generator

Generates synthetic images containing triangles for counting tasks.
Used for evaluating VLM counting and shape recognition capabilities.
...
def draw_triangles(dpi, size, radius, centers, colors, thickness):
    ...
    save_path = f"./data/Triangle/{image_id}.png"
...
with open("./data/Triangle/metadata.json", "w") as fp:
